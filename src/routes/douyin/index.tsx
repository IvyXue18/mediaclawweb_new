...
import { enDouyinHub, zhDouyinHub } from '@/content/platform-hubs/douyin';
...
function urlFor(locale: string, path = '/douyin') {
...
export const Route = createFileRoute('/douyin/')({
  ...
  component: DouyinHubPage,
});

function DouyinHubPage() {
